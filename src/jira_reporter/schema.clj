...
(spec/def ::buddies           (spec/coll-of string?))
...
(spec/def ::issue
  (spec/keys :req-un [::id ::created ::parent-id ::subtask-ids ::type ::status ::assignee ::buddies ::title ::points ::team ::epic ::labels ::history ::current-sprint ::closed-sprints]))

(spec/def ::enriched-issue
  (spec/keys :req-un [::id ::created ::parent-id ::subtask-ids ::type ::status ::assignee ::buddies ::title ::points ::team ::epic ::labels ::history ::current-sprint ::closed-sprints ::lead-time-in-days ::time-in-state]))
